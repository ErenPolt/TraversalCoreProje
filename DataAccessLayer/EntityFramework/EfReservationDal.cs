...
namespace DataAccessLayer.EntityFramework
{
    ...
    {
        public List<Reservation> GetListWithReservationByAccepted(int id)//Onaylanan rezervasyon işlemi;
        {
        ...
        public List<Reservation> GetListWithReservationByPrevious(int id)//Geçmiş rezervasayon  işlemmi için;
        {
            using (var context = new Context())
            {
        ...
        public List<Reservation> GetListWithReservationByWaitApproval(int id)//Onay bekleyen rezervasyon içim;
        {
            using(var context = new Context())
            {
